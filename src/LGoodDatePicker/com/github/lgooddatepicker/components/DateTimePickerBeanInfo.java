...
public class DateTimePickerBeanInfo extends SimpleBeanInfo {
    ...
    private static HashMap<Integer, Pair<String, Image>> iconInformation
        ...
        {
            put(ICON_MONO_16x16, new Pair("/LGoodDatePicker/images/DateTimePickerIcon 16x16.png", null));
            put(ICON_COLOR_16x16, new Pair("/LGoodDatePicker/images/DateTimePickerIcon 16x16.png", null));
            put(ICON_MONO_32x32, new Pair("/LGoodDatePicker/images/DateTimePickerIcon 32x32.png", null));
            put(ICON_COLOR_32x32, new Pair("/LGoodDatePicker/images/DateTimePickerIcon 32x32.png", null));
        }
    };
